...
class CourseController {
    private $db;
    private $course;
    private $records_per_page = 5; // Número de registros por página
    ...
    public function index() {
        ...
        // Verificar si se debe mostrar solo los cursos del usuario autenticado
        if (isset($_GET['user_courses']) && $_GET['user_courses'] == 1) {
            ...
            $courses = $this->course->readAll($from_record_num, $this->records_per_page);
            $total_rows = $this->course->count();
        }
